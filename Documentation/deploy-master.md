...
Boot a single CoreOS machine which will be used as the Kubernetes master node. See the [CoreOS Documentation](https://coreos.com/os/docs/latest/) for guides on launching nodes on supported platforms.
