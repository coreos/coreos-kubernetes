...
1. Use the kube-aws CLI tool to automate cluster deployment. See the [kube-aws Quickstart section](#kube-aws-quickstart) below.
...
The latest releases of kube-aws are published through GitHub.
...
All keys and certs must be base64-encoded and PEM-formatted.
