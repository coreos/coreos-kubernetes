...
**NOTE:** The following upgrade documentation is for installations based on the CoreOS Container Linux + Kubernetes step-by-step [installation guide](https://coreos.com/kubernetes/docs/latest/getting-started.html).
